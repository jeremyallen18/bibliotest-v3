                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($libro['imagen'])): ?>
                                    <img src="<?= htmlspecialchars($libro['imagen']) ?>" alt="Portada del libro" class="book-image">
                                <?php else: ?>
                                    <div class="book-placeholder"><i class="fas fa-book"></i></div>
                                <?php endif; ?>
                            </td>
                            <td>
                                <div class="book-description" title="<?= htmlspecialchars($libro['descripcion'] ?? 'Sin descripción') ?>">
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="eliminar_libro.php?id=<?= $libro['id'] ?>" class="action-btn delete-btn" onclick="return confirm('¿Estás seguro de eliminar este libro?')">
